...
import { c as createError, $ as $fetch, n as hasProtocol, o as isScriptProtocol, i as joinURL, p as defu, w as withQuery, q as sanitizeStatusCode, t as parseURL, e as encodePath, v as decodePath } from '../nitro/nitro.mjs';
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		name: "cabinets-code",
		path: "/cabinets/:code()",
		component: () => import('../build/_code_-BUS3LwVp.mjs')
	},
	{
		name: "cabinets",
		path: "/cabinets",
		component: () => import('../build/cabinets-BEBbMLr1.mjs')
	},
	{
		name: "geofence",
		path: "/geofence",
		component: () => import('../build/geofence-7lkMOWcn.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-AeokOd2O.mjs')
	}
];
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = { default: defineAsyncComponent(() => import('../build/default-sBifGBGE.mjs').then((m) => m.default || m)) };
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-Bf5EF8bP.mjs'));
...
export { $fetch$1 as $, _plugin_vue_export_helper_default as _, useHead$1 as a, useRouter as b, appDiagnostics as c, useNuxtApp as d, asyncDataDefaults as e, fetchDefaults as f, docsBase as g, createError$1 as h, encodeRoutePath as i, useRuntimeConfig as j, nuxtLinkDefaults as k, entry as l, navigateTo as n, prodReporters as p, resolveRouteObject as r, sanitizeTag as s, useRoute$1 as u };
