...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getCookie, deleteCookie, getRequestIP, setCookie, getResponseStatusText } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto, { timingSafeEqual, scrypt as scrypt$1, randomBytes, createHash } from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { z, ZodError } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/zod/index.js';
import { promisify } from 'node:util';
import postgres from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/postgres/src/index.js';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/nitropack/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/source-map/source-map.js';
import { defineDiagnostics, createConsoleReporter } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/nostics/dist/formatters/ansi.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/devalue/index.js';
import { getContext as getContext$1 } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/errx/dist/index.mjs';
import { isVNode, isRef, toValue } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/pathe/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/unhead/dist/utils.mjs';
import { DeprecationsPlugin } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "databaseUrl": "postgres://ecgo:ecgo_dev_password@localhost:55432/ecgo_ops",
  "staleMinutes": "10"
};
const envOptions = {
  prefix: "NITRO_",
...
const _I2OkoSJFfX1FRiUFOwOYUMfk3GYq5WuCtJmod8zZo = (function(nitro) {
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Dashboard operasional internal ECGO untuk memantau cabinet battery swap."},{"name":"theme-color","content":"#0B1210"}],"link":[{"rel":"icon","type":"image/png","href":"/brand/favicon.png"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"id"},"title":"ECGO Ops · Battery Swap Monitoring"};
...
const rootDir = "/home/yuyuid/FEDORA-PROJECT/ecgo/ecgo-ops-dashboard";
...
const plugins = [
  _I2OkoSJFfX1FRiUFOwOYUMfk3GYq5WuCtJmod8zZo,
...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"235cc-6pvm6vy07dta5K5Xfkh96U013f4\"",
    "mtime": "2026-08-10T11:00:19.175Z",
    "size": 144844,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"8cdb4-2bQwOX3VsAvb9vWDgc8+0dQVXL4\"",
    "mtime": "2026-08-10T11:00:19.176Z",
    "size": 576948,
    "path": "index.mjs.map"
  }
};
...
const _fQBb_7 = eventHandler((event) => {
...
const _lazy_k26TeJ = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_YOxdWO = () => Promise.resolve().then(function () { return logout_post$1; });
const _lazy_s_qTAm = () => Promise.resolve().then(function () { return me_get$1; });
const _lazy_6TUM79 = () => Promise.resolve().then(function () { return _code__get$1; });
const _lazy_coVEoA = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_fsS6eH = () => Promise.resolve().then(function () { return health_get$1; });
const _lazy_pRBJiA = () => Promise.resolve().then(function () { return summary_get$1; });
const _lazy_I3bmvC = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _fQBb_7, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/login', handler: _lazy_k26TeJ, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/logout', handler: _lazy_YOxdWO, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/me', handler: _lazy_s_qTAm, lazy: true, middleware: false, method: "get" },
  { route: '/api/cabinets/:code', handler: _lazy_6TUM79, lazy: true, middleware: false, method: "get" },
  { route: '/api/cabinets', handler: _lazy_coVEoA, lazy: true, middleware: false, method: "get" },
  { route: '/api/health', handler: _lazy_fsS6eH, lazy: true, middleware: false, method: "get" },
  { route: '/api/summary', handler: _lazy_pRBJiA, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_I3bmvC, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_I3bmvC, lazy: true, middleware: false, method: undefined }
];
...
const loginSchema = z.object({
  email: z.string().trim().min(1, "Email wajib diisi").max(254, "Email terlalu panjang").email("Format email tidak valid"),
...
const unauthorized = (message = "Sesi tidak valid atau sudah berakhir. Silakan masuk kembali.") => new ApiError("UNAUTHORIZED", message);
...
async function readJsonBody(event) {
  try {
    ...
    throw new ApiError("VALIDATION_ERROR", "Body request bukan JSON yang valid");
  }
}
...
function respondWithError(event, error) {
  if (error instanceof ApiError) {
    setResponseStatus(event, HTTP_STATUS_BY_CODE[error.code]);
...
function dummyHash() {
  dummyHashPromise != null ? dummyHashPromise : dummyHashPromise = hashPassword(randomBytes(32).toString("base64"));
  return dummyHashPromise;
}
const SESSION_COOKIE = "ecgo_session";
...
async function createSession(event, userId) {
  ...
  await sql`
    ...
    VALUES (
      ...
      ${userId},
      ${expiresAt},
      ${(_b = (_a = getRequestHeader(event, "user-agent")) == null ? void 0 : _a.slice(0, 300)) != null ? _b : null},
      ${(_c = getRequestIP(event, { xForwardedFor: true })) != null ? _c : null}
    )
  `;
  setCookie(event, SESSION_COOKIE, token, {
    ...
    // menutup CSRF untuk endpoint yang mengubah state di aplikasi ini
    // (login dan logout). Begitu ada mutasi yang lebih serius, saya akan
    // menambahkan token CSRF, bukan bersandar pada SameSite saja.
    sameSite: "lax",
    secure: false,
    path: "/",
...
async function resolveSession(event) {
  ...
  const [row] = await sql`
    ...
    WHERE s.token_hash = ${sha256(token)}
      ...
      -- Akun yang dinonaktifkan langsung kehilangan akses tanpa perlu menunggu
      -- sesinya berakhir.
      AND u.active
...
async function loadSessionUser(userId, expiresAt) {
  const sql = useDb();
  const [row] = await sql`
    SELECT
      u.id::int,
...
async function destroySession(event) {
  const token = getCookie(event, SESSION_COOKIE);
  if (token) {
    await useDb()`DELETE FROM sessions WHERE token_hash = ${sha256(token)}`;
  }
  deleteCookie(event, SESSION_COOKIE, { path: "/" });
}
async function pruneExpiredSessions() {
  await useDb()`DELETE FROM sessions WHERE expires_at < now()`;
}
...
function checkLoginRateLimit(key) {
  ...
  if (entry.count > MAX_ATTEMPTS) {
    const retryInMinutes = Math.ceil((WINDOW_MS - (now - entry.firstAt)) / 6e4);
    throw new ApiError(
      "TOO_MANY_REQUESTS",
...
const loginRateKey = (event, email) => {
  var _a;
  return `${(_a = getRequestIP(event, { xForwardedFor: true })) != null ? _a : "unknown"}:${email.toLowerCase()}`;
};

const login_post = defineApiHandler(async (event) => {
  var _a;
  const { email, password } = parseOrThrow(loginSchema, await readJsonBody(event), "Data masuk");
  checkLoginRateLimit(loginRateKey(event, email));
  const sql = useDb();
  ...
  `;
  const passwordOk = await verifyPassword(password, (_a = user == null ? void 0 : user.password_hash) != null ? _a : await dummyHash());
  if (!user || !passwordOk) {
    throw new ApiError("UNAUTHORIZED", "Email atau password salah");
  }
  clearLoginRateLimit(loginRateKey(event, email));
...
const logout_post = defineApiHandler(async (event) => {
...
const me_get = defineApiHandler(async (event) => {
  const session = await resolveSession(event);
  return { data: session ? toSessionUser(session) : null };
});
...
const _code__get = defineApiHandler(async (event) => {
  ...
  const scopeClause = session.allowedBranchIds === null ? sql`true` : sql`c.branch_id = ANY(${session.allowedBranchIds}::bigint[])`;
...
const index_get = defineApiHandler(async (event) => {
  var _a, _b;
  const session = await requireSession(event);
  const query = parseOrThrow(cabinetListQuerySchema, getQuery$1(event), "Parameter pencarian");
  const sql = useDb();
...
const summary_get = defineApiHandler(async (event) => {
  ...
  const [row] = await sql`
    ...
    SELECT
      ...
      -- Hitungan swap ikut dibatasi ke cabinet yang terlihat, lewat join ke CTE
      -- di atas — bukan count global yang akan membocorkan throughput cabang lain.
      (
        SELECT count(*)::int FROM swap_transactions s
