...
declare module "nitropack/types" {
  ...
  interface InternalApi {
    ...
    '/api/cabinets/:code': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/cabinets/[code].get').default>>>>
    }
    '/api/cabinets': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/cabinets/index.get').default>>>>
    }
    '/api/health': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/health.get').default>>>>
    }
    '/api/summary': {
      'get': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/api/summary.get').default>>>>
    }
    '/__nuxt_error': {
